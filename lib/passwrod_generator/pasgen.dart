...
class _PasswordGeneratorPageState extends State<PasswordGeneratorPage> {
  ...
  // Karakter-karakter untuk tiap opsi
  ...
  final String _specialCharacters = '!@#\$%^&*()_-+=<>?';

  String generatePassword() {
    String chars = '';
    if (_includeUppercase) chars += _upperCaseLetters;
    if (_includeLowercase) chars += _lowerCaseLetters;
    if (_includeNumbers) chars += _numbers;
    if (_includeSpecial) chars += _specialCharacters;
